                                ...
                                <CardHeader>
                                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                        <div className="flex items-center gap-4">
                                            <div className="rounded-xl bg-primary/20 p-3 shadow-sm backdrop-blur-sm dark:bg-primary/30">
                                                <User className="dark:text-primary-light text-primary" size={24} />
                                            </div>
                                            <div>
                                    ...
                                    <form onSubmit={handleSubmit} className="p-6">
                                        <div className="mx-auto max-w-xl space-y-6">
                                            <div className="space-y-2">
                                                ...
                                                >
                                                    <User size={14} className="dark:text-primary-light text-primary" />
                                                    Name
                                                </Label>
                                                ...
                                                <div className="group relative">
                                                    ...
                                                    <User
                                                        size={18}
                                                        className="dark:group-hover:text-primary-light absolute top-1/2 left-3 -translate-y-1/2 text-gray-400 transition-colors group-hover:text-primary dark:text-gray-500"
                                                    />
                                                </div>
                                            ...
                                            <div className="space-y-2">
                                                <Label
                                                    ...
                                                    className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-200"
                                                >
                                                    <Mail size={14} className="dark:text-primary-light text-primary" />
                                                    Email
                                                </Label>
                                            ...
                                            <div className="space-y-2">
                                                <Label
                                                    ...
                                                    className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-200"
                                                >
                                                    <Phone size={14} className="dark:text-primary-light text-primary" />
                                                    Phone
                                                </Label>
                                            ...
                                            <div className="space-y-2">
                                                <Label
                                                    ...
                                                    className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-200"
                                                >
                                                    <Lock size={14} className="dark:text-primary-light text-primary" />
                                                    Password
                                                </Label>
                                            ...
                                            <div className="space-y-2">
                                                <Label
                                                    ...
                                                    className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-200"
                                                >
                                                    <ImageIcon size={14} className="dark:text-primary-light text-primary" />
                                                    Admin Avatar
                                                </Label>
